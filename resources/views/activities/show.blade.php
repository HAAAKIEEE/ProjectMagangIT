...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4">
        ...
        <form method="GET" action="{{ route('activities.show', $activity->id) }}" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Search for MV, Barge, or Surveyor..." aria-label="Search" value="{{ request('search') }}">
        ...
        <table class="table table-bordered text-center table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="{{ route('roa.edit',$roa->id) }}" class="btn btn-warning btn-sm mr-3" style="margin-right: 10px;">Edit</a>
                        </div>
                    </td>
                </tr>
                @endforeach
        ...
        <table class="table table-bordered text-center table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="{{ route('coas.edit',$coa->id) }}" class="btn btn-warning btn-sm mr-3" style="margin-right: 10px;">Edit</a>
                        </div>
                    </td>
                </tr>
                @endforeach
        ...
        <table class="table table-bordered text-center table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="{{ route('ashanls.edit', $ashanl->id) }}" class="btn btn-warning btn-sm mr-3" style="margin-right: 10px;">Edit</a>
                        </div>
