...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('coas.store', ['activity' => $activity->id, 'shipment' => $shipment->id]) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="number" name="number" placeholder="Masukkan COA Number"
                    required>
            </div>
            <div class="form-group">
                <label for="tm2">TM</label>
                <input type="number" class="form-control" id="tm2" name="tm2" placeholder="Masukkan TM"
                    step="any" required>
            </div>
            <div class="form-group">
                <label for="im2">IM</label>
                <input type="number" class="form-control" id="im2" name="im2" placeholder="Masukkan IM"
                    step="any" required>
            </div>
            ...
            <div class="form-row-inline">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="ash1" name="ash1" placeholder="Masukkan ASH"
                        step="any" required>
                </div>
                <div class="form-group">
                    <label for="ash3">ASH (%db)</label>
                    <input type="text" class="form-control" id="ash3" name="ash3" placeholder="ASH (%db)"
                        required readonly style="background-color: #f0f0f0; color: #333; border: 1px solid #ccc;"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="vm2" name="vm2" placeholder="Masukkan VM"
                    step="any">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="ts3" name="ts3" placeholder="Masukkan TS (%adb)"
                    step="any" required>
            </div>

            <div class="form-group">
                <label for="ts2">TS (%db)</label>
                <input type="text" class="form-control" id="ts2" name="ts2" placeholder="Masukkan TS (%db)"
                    required readonly oninput="validateNumber(this)">
            </div>
            ...
            <div class="form-row-inline">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="adb" name="adb" placeholder="Masukkan ADB"
                        step="any" required>
                </div>
                <div class="form-group">
                    <label for="arb">ARB</label>
                    <input type="text" class="form-control" id="arb" name="arb" placeholder="ARB" required
                        readonly style="background-color: #f0f0f0; color: #333; border: 1px solid #ccc;"
                        oninput="validateNumber(this)">
                </div>
                <div class="form-group">
                    <label for="daf">DAF</label>
                    <input type="text" class="form-control" id="daf" name="daf" placeholder="DAF" required
                        readonly style="background-color: #f0f0f0; color: #333; border: 1px solid #ccc;"
                        oninput="validateNumber(this)">
                </div>
            </div>
