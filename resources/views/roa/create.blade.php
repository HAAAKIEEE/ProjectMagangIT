        ...
        <form action="{{ route('roa.store', ['activity' => $activity->id, 'shipment' => $shipment->id]) }}" method="POST">
            ...
            <div class="form-row-inline">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ash" name="ash" placeholder="Masukkan ASH" step="0.01" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-row-inline">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Adb" name="Adb" placeholder="Masukkan ADB"
                        required>
                </div>
                <div class="form-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            function updateFields() {
                const im = parseFloat(document.getElementById('im').value.replace(',', '.')) || 0;
                const ash = parseFloat(document.getElementById('ash').value.replace(',', '.')) || 0;
                const vm = parseFloat(document.getElementById('vm').value.replace(',', '.')) || 0;
                const tm = parseFloat(document.getElementById('tm').value.replace(',', '.')) || 0;
                const adb = parseFloat(document.getElementById('Adb').value.replace(',', '.')) || 0;
