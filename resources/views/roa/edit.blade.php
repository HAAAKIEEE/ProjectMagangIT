...
<div class="container">
        ...
        <div class="form-group">
            ...
            <input type="number"  class="form-control" id="tm" name="tm" value="{{ old('tm', $roa->tm) }}"  placeholder="Masukkan TM" required>
        </div>
        <div class="form-group">
            <label for="im">IM</label>
            <input type="number"  class="form-control" id="im" name="im" value="{{ old('im', $roa->im) }}" placeholder="Masukkan IM" required>
        </div>

        <div class="form-row-inline">
            <div class="form-group">
                <label for="ash">ASH</label>
                <input type="number"  class="form-control" id="ash" name="ash"value="{{ old('ash', $roa->ash) }}" placeholder="Masukkan ASH" required>
            </div>
            <div class="form-group">
                <label for="ash2">ASH</label>
                <input type="number"  class="form-control" id="ash2" name="ash2" value="{{ old('ash2', $roa->ash2) }}" readonly>
            </div>
        </div>
        <div class="form-group">
            <label for="vm">VM</label>
            <input type="number"  class="form-control" id="vm" name="vm" value="{{ old('vm', $roa->vm) }}" placeholder="Masukkan VM">
        </div>

        <div class="form-group">
            <label for="fc">FC</label>
            <input type="number"  class="form-control" id="fc" name="fc" value="{{ old('fc', $roa->fc) }}" placeholder="Masukkan FC" readonly>
        </div>
        <div class="form-group">
            <label for="ts">TS</label>
            <input type="number"  class="form-control" id="ts" name="ts" value="{{ old('ts', $roa->ts) }}" placeholder="Masukkan TS" required>
        </div>
        <h2>CV</h2>
        <div class="form-row-inline">
            <div class="form-group">
                <label for="Adb">ADB</label>
                <input type="number"  class="form-control" id="Adb" name="Adb" value="{{ old('Adb', $roa->Adb) }}" placeholder="Masukkan ADB" required>
            </div>
            <div class="form-group">
                <label for="Arb">ARB</label>
                <input type="number"  class="form-control" id="Arb" name="Arb" value="{{ old('Arb', $roa->Arb) }}" placeholder="Masukkan ARB" readonly>
            </div>
            <div class="form-group">
                <label for="Daf">DAF</label>
                <input type="number"  class="form-control" id="Daf" name="Daf" value="{{ old('Daf', $roa->Daf) }}" placeholder="Masukkan DAF" readonly>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="Analisis_Standar" name="Analisis_Standar" required>
                <option value="ASMT" {{ old('Analisis_Standar', $roa->Analisis_Standar) == 'ASMT' ? 'selected' : '' }}>ASMT</option>
                <option value="ISO" {{ old('Analisis_Standar', $roa->Analisis_Standar) == 'ISO' ? 'selected' : '' }}>ISO</option>
            </select>
        </div>
